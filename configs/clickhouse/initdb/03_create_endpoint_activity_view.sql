...
-- Provides a telemetry-derived endpoint inventory baseline across ingest lanes.
--
-- Notes:
-- - Endpoint identity prefers fields['computer'], then fields['hostname'], then fields['host'].
-- - Status buckets are best-effort activity hints (active/idle/stale) for local MVP triage.
